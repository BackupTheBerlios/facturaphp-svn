			...
			<table width="100%" cellpadding="0" cellspacing="0"  bgcolor="#000000">
				...
				<TABLE width="95%" align="center">
					<tr class="cabeceraMultiLinea">
						<td width="50%" height="23" nowrap>Identificador de Empresa: {$objeto->id_client}</td>
						<td nowrap width="50%">{section name="indice" loop=$acciones}				
				
						{if $acciones[indice]== 'modify'}
						<a href="index.php?module=clients&method={$acciones[indice]}&id={$objeto->id_client}">
						...
						<td colspan="2">
							<table width="100%" align="center">
                              ...
                              <tr height="15px">
                                ...
                                <td nowrap width="25%" class="datosVista">{$objeto->full_name}</td>
