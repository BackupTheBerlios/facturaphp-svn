...
<form method="post" action="index.php?module=services&method=modify&id={$objeto->id_service}" name="form_central" enctype="multipart/form-data">
		...
		<td valign="top">
			<table width="100%" cellpadding="0" cellspacing="0"  bgcolor="#000000">
						...
						<td width="93%" valign="middle"  nowrap>Modificar Servicio</td>
			  </tr>
		  </table>
						<br>
		...
		<table width="50%" align="center">
				...
				<tr>
						...
						<td><a href="index.php?module=services&method=show&id={$objeto->id_product}"><img src="{$objeto->path_photo}" width="80" height="80"></a>
