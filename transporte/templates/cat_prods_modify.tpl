<td valign="top">
<form method="post" action="index.php?module=cat_prods&method=modify&id={$objeto->id_cat_prod}" name="form_central" enctype="multipart/form-data">
		...
		<td valign="top">
			<table width="100%" cellpadding="0" cellspacing="0"  bgcolor="#000000">
						...
						<td width="93%" valign="middle"  nowrap>Modificar Categor&iacute;a de Producto</td>
			  </tr>
		  </table>
						<br>
		<table width="250px" align="center">
				  ...
				  <tr>
					...
					<tr>
						...
						<td><a href="index.php?module=cat_prods&method=show&id={$objeto->id_cat_prod}"><img src="{$objeto->path_photo}" width="80" height="80"></a>
