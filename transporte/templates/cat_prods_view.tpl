					...
					<tr>
						<td valign="top">
							...
							<tr class="cabeceraMultiLinea">
								<td colspan="2" height="23" nowrap>Identificador de Categor&iacute;a: {$objeto->id_cat_prod}</td>
								<td colspan="2">&nbsp;</td>
							</tr>
                              <tr height="15px">
							...
							{if $objeto->id_parent_cat==$objeto->cat_prods_list[nombre].id_cat_prod}{$objeto->cat_prods_list[nombre].name}{/if}>
						...
						{/if}	
                              ...
                              <tr>
                                ...
                                <td align="center" colspan="2">
									...
									{if $acciones[indice]== 'modify'}
										<a href="index.php?module=cat_prods&method={$acciones[indice]}&id={$objeto->id_cat_prod}">
                    		  ...
                    		  <tr>
                               ...
                               <a href="index.php?module=cat_prods&method=show&id={$objeto->id_cat_prod}"><img src="{$objeto->path_photo}" height="120"></a>
					   </td>
							 </tr>
							 <tr>      
