					...
					<tr>
						<td valign="top">
							...
							<tr class="cabeceraMultiLinea">
								<td colspan="2" height="23" nowrap>Identificador de Categor&iacute;a: <?php echo $this->_tpl_vars['objeto']->id_product; ?>
</td>
...
.gif" border="0"></a>
                              ...
                              <tr>
                               ...
                               <a href="index.php?module=products&method=show&id=<?php echo $this->_tpl_vars['objeto']->id_product; ?>
