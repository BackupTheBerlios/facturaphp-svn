...
">
							...
							<option value="1" <?php if ($this->_tpl_vars['objeto']->active == 1): ?>selected<?php endif; ?>>Sí</option>
						</select></td>
					</tr>	
				<tr>
...
">
							<option value="0" <?php if ($this->_tpl_vars['objeto']->publico == 0): ?>selected<?php endif; ?>>No</option>
							<option value="1" <?php if ($this->_tpl_vars['objeto']->publico == 1): ?>selected<?php endif; ?>>Sí</option>
						</select> </td>
					</tr>		
				<tr>
...
?>
								<?php if ($this->_tpl_vars['padres'][$this->_sections['indice']['index']]['id_module'] != $this->_tpl_vars['objeto']->id_module): ?>
