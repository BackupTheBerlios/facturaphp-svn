<?php /* Smarty version 2.6.3, created on 2005-04-07 19:08:44
         compiled from contacts_view.tpl */ ?>
<td valign="top">
			...
			<table width="100%" cellpadding="0" cellspacing="0"  bgcolor="#000000">
				...
				<TABLE width="95%" align="center">
					<tr class="cabeceraMultiLinea">
						<td width="50%" height="23" nowrap>Identificador de Contacto: <?php echo $this->_tpl_vars['objeto']->id_contact; ?>
...
&id=<?php echo $this->_tpl_vars['objeto']->id_contact; ?>
">
							...
							<table width="90%" align="center">                             
                              ...
                              <tr height="15px">
                               <td height="21" nowrap class="camposVistas">Fecha nacimiento: </td>
                                <td nowrap class="datosVista"><?php echo $this->_tpl_vars['objeto']->birthday; ?>
</td>
