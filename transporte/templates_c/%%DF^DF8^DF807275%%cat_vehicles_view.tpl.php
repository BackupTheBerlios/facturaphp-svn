<?php /* Smarty version 2.6.3, created on 2005-03-03 22:09:24
         compiled from cat_vehicles_view.tpl */ ?>
<td valign="top">
					...
					<tr>
						<td valign="top">
							...
							<tr class="cabeceraMultiLinea">
								<td height="23" nowrap>Identificador de la categoría: <?php echo $this->_tpl_vars['objeto']->id_cat_vehicle; ?>
</td>
...
?>				
						...
						<a href="index.php?module=cat_vehicles&method=<?php echo $this->_tpl_vars['acciones'][$this->_sections['indice']['index']]; ?>
&id=<?php echo $this->_tpl_vars['objeto']->id_cat_vehicle; ?>
">
...
.gif" border="0" ></a>
						...
						<?php endfor; endif; ?>
                              ...
                              <tr height="15px">
                                ...
                                <td nowrap width="25%" class="datosVista"><?php echo $this->_tpl_vars['objeto']->name_web; ?>
</td>
                              </tr>
                               <tr>
