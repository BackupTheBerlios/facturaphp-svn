<?php /* Smarty version 2.6.3, created on 2005-04-21 12:58:14
         compiled from cat_prods_list.tpl */ ?>
<td valign="top">
 ...
 ?>
	  ...
	  <table width="100%" cellpadding="0" cellspacing="0"  bgcolor="#000000">
						...
						<td width="93%" valign="middle"  nowrap>
						  Buscar Categor&iacute;as de productos </td>
				</tr>
			  </table>
			  <table width="100%">
...
" class="textoMenu"></td>
			    ...
			    <tr>
				  ...
				  <tr>
				 	<td colspan="2" align="center"><input type="submit" value="Buscar" name="submit_cat_prods_search" class="botones"></td>
				 </tr>
				 </table>
				</form><br>
				  <div name="divMostrar" id="divMostrar" >
					 ...
					 <script>	
					  	document.getElementById("divMostrar").innerHTML = cat_prods_1;
					  </script>
