<?php /* Smarty version 2.6.3, created on 2005-03-17 11:39:58
         compiled from laborers_view.tpl */ ?>
<td valign="top">
...
unset($_smarty_tpl_vars);
 ?>
			<table width="100%" cellpadding="0" cellspacing="0"  bgcolor="#000000">
						...
						<td width="93%" valign="middle" nowrap>Detalle de peones </td>
				</tr>
						...
						<td valign="top">
							<table width="100%">
                              ...
                              <tr>
                                ...
                                <td nowrap class="datosVista"><?php echo $this->_tpl_vars['emp_laborer']; ?>
</td>
                              </tr>
                    		  <tr>      
			      				<td align="center">
...
?>			
									<?php if ($this->_tpl_vars['acciones'][$this->_sections['indice']['index']] == 'modify'): ?>
										<a href="index.php?module=laborers&method=<?php echo $this->_tpl_vars['acciones'][$this->_sections['indice']['index']]; ?>
&id=<?php echo $this->_tpl_vars['objeto']->id_laborer; ?>
">
...
">
										<img src="pics/btn<?php echo $this->_tpl_vars['acciones'][$this->_sections['indice']['index']]; ?>
.gif" border="0" onClick="confirm('¿Desea borrar este registro?\nSi pulsa Sí se borrarán tambien los registros relacionados con este peón')"></a>
									<?php endif; ?>	
									<?php endfor; endif; ?>
								</td>
							 </tr>
					   		...
					   		<br>
							<p align="center" class="cabeceraCampoFormulario">Listados de vehículos asignados al peón</p>
							<br>
					<a name="listado">
