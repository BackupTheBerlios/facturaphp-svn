...
*/
	...
	//**************************************************************
	//Configuraci�n De Dani (Windows-PORTATIL)
/*	
	$DDBB_NAME="transporte";
	$DDBB_USER="root";
	$DDBB_PASS="";
	...
	*/
	...
	$DDBB_TYPE="mysql";
	$DDBB_PORT="3306";
	$INSTALL_DIR="/var/www/proyectos/transporte/";	
	
	//**************************************************************
	//Configuraci�n De Roc�o (Linux)
	/*	
	$DDBB_NAME="transporte";
	$DDBB_USER="root";
	$DDBB_PASS="sta3war2";
...
/*
	...
	*/
	...
	$SMARTY_TEMPLATES_C_DIR=$INSTALL_DIR."templates_c".$SLASH;
	$SMARTY_CONFIGS_DIR=$INSTALL_DIR."configs".$SLASH;
	$SMARTY_CACHE_DIR=$INSTALL_DIR."cache".$SLASH;
	$WEB_SERVER="";
	$WEB_DIR="";
	$BASE_URL="";
?>
